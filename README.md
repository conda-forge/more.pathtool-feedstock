About more.pathtool-feedstock
=============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/more.pathtool-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/morepath/more.pathtool
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3128&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/more.pathtool-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `more.pathtool` can be installed with `conda`:
...
```
mamba install more.pathtool
```

It is possible to list all of the versions of `more.pathtool` available on your platform with `conda`:
...
```
mamba search more.pathtool --channel conda-forge
```
...
mamba repoquery search more.pathtool --channel conda-forge

# List packages depending on `more.pathtool`:
mamba repoquery whoneeds more.pathtool --channel conda-forge

# List dependencies of `more.pathtool`:
mamba repoquery depends more.pathtool --channel conda-forge
```
